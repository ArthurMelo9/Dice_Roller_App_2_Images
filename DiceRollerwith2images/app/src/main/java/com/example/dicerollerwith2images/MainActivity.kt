package com.example.dicerollerwith2images
...
class MainActivity : AppCompatActivity() {
    ...
    private fun rollDice(){
        ...
        val sum = (result1 + result2).toString()
        val sumText:TextView = findViewById(R.id.textView)
        sumText.text = sum
        ...
        diceImage1.contentDescription = result1.toString()
